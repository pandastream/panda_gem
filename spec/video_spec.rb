...
describe Panda::Video do
  ...
  it "should return a json on attributes" do
    ...
    Panda.load_json( video.to_json ).should == {"attr" => "value", "cloud_id" => "my_cloud_id"}
  end
  ...
  it 'should generate json of encodings' do
    ...
    Panda.load_json( video.encodings.first.to_json ).should == {"abc" => "my_source_url", "id" => "456", "cloud_id" => "my_cloud_id"}
  end
